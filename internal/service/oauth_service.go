...
func NewOAuthService(google oauth.OauthGoogleService, jwt JWTService, session SessionService, userRepository repository.UserRepository, logger *logrus.Logger, stateSecret string, allowedRedirects []string) OAuthService {
    return &oAuthService{
        google:           google,
        jwt:              jwt,
        session:          session,
