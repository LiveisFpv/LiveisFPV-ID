...
const docTemplate = `{
        ...
        "/auth/admin/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by locale (e.g., ru)",
                        "name": "locale",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/presenters.UserAdminListResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create request with roles",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/presenters.UserCreateWithRolesRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/presenters.UserUpdateAdminRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/presenters.PasswordResetRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/presenters.PasswordResetResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "presenters.PasswordResetRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "presenters.PasswordResetResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "presenters.UserAdminListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/presenters.UserAdminResponse"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "presenters.UserCreateWithRolesRequest": {
            "type": "object",
            "required": [
                "email",
                "first_name",
